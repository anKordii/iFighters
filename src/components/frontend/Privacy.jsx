...
<div className="container pt-5 mt-5">
   <div className="row">
      ...
      <h2 className="bb__small mb-4">Polityka Prywatności</h2>
   </div>
   ...
   <ul>
      <li>
         <p><strong>Serwis</strong> - serwis internetowy "iFighters" działający pod adresem https://ifighters.win/</p>
      </li>
      <li>
      ...
      <li>
         <p><strong>Administrator Serwisu / Danych</strong> - Administratorem Serwisu oraz Administratorem Danych (dalej Administrator) jest <a href="https://BeyondLabs.pl">BeyondLabs.pl</a></p>
      </li>
      <li>
   ...
   <h2 className="text-center">§2 Inspektor Ochrony Danych</h2>
   ...
   <h2 className="text-center">§3 Rodzaje Plików Cookies</h2>
   <ul>
      <li>
   ...
   <h2 className="text-center">§4 Bezpieczeństwo składowania danych</h2>
   <ul>
      <li>
   ...
   <h2 className="text-center">§5 Cele do których wykorzystywane są pliki Cookie</h2>
   <ul id="cele">
   ...
   <h2 className="text-center">§6 Cele przetwarzania danych osobowych</h2>
   ...
   <h2 className="text-center">§7 Pliki Cookies Serwisów zewnętrznych</h2>
   ...
   <h2 className="text-center">§8 Rodzaje gromadzonych danych</h2>
   ...
   <h2 className="text-center">§9 Dostęp do danych osobowych przez podmioty trzecie</h2>
   ...
   <p>Administrator w celu prowadzenia serwisu korzysta z usług zewnętrznego dostawcy hostingu, VPS lub Serwerów Dedykowanych - <strong><a rel="nofollow external" href="https://www.digitalocean.com/legal/privacy-policy">DigitalOcean, Inc.</a></strong>. Wszelkie dane gromadzone i przetwarzane w serwisie są przechowywane i przetwarzane w infrastrukturze usługodawcy zlokalizowanej w obrębie granic Unii Europejskiej. Istnieje możliwość dostępu do danych wskutek prac serwisowych realizowanych przez personel usługodawcy. Dostęp do tych danych reguluje umowa zawarta pomiędzy Administratorem a Usługodawcą.</p>
   <br />
   <h2 className="text-center">§10 Sposób przetwarzania danych osobowych</h2>
   ...
   <h2 className="text-center">§11 Podstawy prawne przetwarzania danych osobowych</h2>
   ...
   <h2 className="text-center">§12 Okres przetwarzania danych osobowych</h2>
   <p><strong>Dane anonimowe (bez danych osobowych) gromadzone automatycznie:</strong></p>
   ...
   <h2 className="text-center">§13 Prawa Użytkowników związane z przetwarzaniem danych osobowych</h2>
   <p>Serwis gromadzi i przetwarza dane Użytkowników na podstawie:</p>
   <ul>
      <li>
   ...
   <h2 className="text-center">§14 Kontakt do Administratora</h2>
   <p>Z Administratorem można skontaktować się w jeden z poniższych sposobów</p>
   <ul>
      <li>
         <p><strong>Adres poczty elektronicznej</strong> - kontakt@ifighters.win</p>
      </li>
   </ul>
   <h2 className="text-center">§15 Wymagania Serwisu</h2>
   <ul>
      <li>
   ...
   <h2 className="text-center">§16 Linki zewnętrzne</h2>
   ...
   <h2 className="text-center">§17 Zmiany w Polityce Prywatności</h2>
   <ul>
      <li>
